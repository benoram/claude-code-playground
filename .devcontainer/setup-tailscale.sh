...
echo ""
echo "[INFO] SSH to Tailscale IPs (100.64.0.0/10) works automatically:"
echo "[INFO]   ssh user@100.x.x.x"
echo ""
echo "[INFO] For other protocols, use the SOCKS5 proxy on localhost:1080:"
